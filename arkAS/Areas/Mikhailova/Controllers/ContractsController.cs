using arkAS.Areas.Mikhailova.BLL;
using arkAS.BLL;
...
namespace arkAS.Areas.Mikhailova.Controllers
{
    public class ContractsController : BaseController
    {
        ...
        public string CopyFileOnFolderID(int id, string path)
        {
            ...
            string pathFolder = "/Areas/Mikhailova/uploads/Contracts/";
        ...
        {
            string directoryPath = Server.MapPath("~/Areas/Mikhailova/uploads/Contracts/") + "ID" + docId + "/";
            var res = false;
            var fileName = "";
            var exMessage = "";
            ...
            try
            {
                if (Request.Files.Count > 0)
                {
                    ...
                    fileName = "/Areas/Mikhailova/uploads/Contracts/ID" + docId + "/" + fileName;
